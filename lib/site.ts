export const site = {
  name: "Thirugnanam V S",
  shortName: "Thirugnanam",
  url: "https://thirugnanam.dev", // update after deploying
  headline:
    "Electronics Engineering (VLSI Design & Technology) Student · Software Developer · AI & ML Enthusiast",
  tagline:
